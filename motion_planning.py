...
if __name__ == "__main__":
    ...
    parser.add_argument('--lon', type=float, default=-122.39743738, help="goal longitude")
    parser.add_argument('--lat', type=float, default=37.79263316,   help="goal latitude")
    parser.add_argument('--alt', type=float, default=-5,            help="goal altitude")
